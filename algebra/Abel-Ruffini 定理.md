...
本篇文章相对较深地依赖了之前对[域](https://zhuanlan.zhihu.com/p/2059701837423497662)和[ Galois 理论](https://zhuanlan.zhihu.com/p/2060047607557367643)的讲解，而关于[群](https://zhuanlan.zhihu.com/p/2012437604285572037)的讲解，主要集中在文章的可解群这一节，主要是 Cauchy 定理，可解群的定义，以及 $S_5$ 不可解，这三个单点，知识点相对较浅，如果要看原文，搜索关键词为“Cauchy 定理”，“可解序列与可解性”，“置换群基础概念回顾”，“五次及以上对称群的不可解性”，看完二级小标题下内容即可。
...
>**定理（Cauchy 定理）**
>
>如果有限群 $G$ 阶数为 $n$，且存在质数 $p$ 使得 $p\mid n$，则 $G$ 存在阶数为 $p$ 的子群。
...
因为存在一个具体的五次方程的实例，对于一般的 $n$ 次方程，其中 $n\ge 5$，考虑多项式 $(x-1)^{n-5}(x^5-4x+2)$，可知对五次及以上的代数方程，不存在一般的根式求根公式。
# 尾声
